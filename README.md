...
### .NET / C# Developer · Open Source Builder · Engineering Pragmatist

专注于 **.NET 后端开发、工程化实践与开源工具构建**，也持续在 **TypeScript / Node.js / Go** 方向进行探索与落地。
...
如果你也关注 .NET、工程化、开源工具或服务端实践，欢迎交流。
